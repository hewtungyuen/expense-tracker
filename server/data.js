    ...
    if (overseasTransaction) {
        ...
        if (overseasCurrency) {
            if (tripName == "Vietnam") {
                ...
                output.date = faker.date.between('2021-01-01T00:00:00.000Z', '2022-01-01T00:00:00.000Z')
            } else if (tripName == "Malaysia") {
                output.expenseAmountOverseas = faker.finance.amount(3, 300)
                output.date = faker.date.between('2022-01-01T00:00:00.000Z', '2023-01-01T00:00:00.000Z')
            }
            output.expenseAmountSgd = (output.expenseAmountOverseas/exchangeRate).toFixed(2)
